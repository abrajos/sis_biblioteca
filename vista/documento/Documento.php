		...
		},
		{
			config: {
				...
				store: new Ext.data.JsonStore({
					...
					totalProperty: 'total',
					fields: ['id_ubicacion', 'oficina','nombre','nivel','estante'],
					remoteSort: true,
				...
				tpl:'<tpl for="."><div class="x-combo-list-item"><p>Oficina: {oficina} - Nivel: {nivel} - Estante: {estante}</p><p>Lugar:{nombre}</p> </div></tpl>',
